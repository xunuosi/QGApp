...
public class CollectDicFragment extends BaseCollectFragment implements ICollectBookFragmentView,
        OnRefreshListener, OnLoadMoreListener {
    @Inject
    CollectDicPresenter mPresenter;
    ...
    public static CollectDicFragment newInstance() {
        CollectDicFragment fragment = new CollectDicFragment();
        return fragment;
    }
