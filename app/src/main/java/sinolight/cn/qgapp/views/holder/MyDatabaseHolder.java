...
public class MyDatabaseHolder extends RecyclerView.ViewHolder {
    @BindView(R.id.iv_item_my_database)
    SimpleDraweeView mIvItemMyDatabase;
    @BindView(R.id.tv_item_my_database)
    TextView mTvItemMyDatabase;
    @BindView(R.id.item_my_database_root)
    ConstraintLayout mItemMyDatabaseRoot;
    ...
    public MyDatabaseHolder(View layout) {
        super(layout);
    ...
    private void bindData() {
        ...
        mTvItemMyDatabase.setText(baseBean.getName());
