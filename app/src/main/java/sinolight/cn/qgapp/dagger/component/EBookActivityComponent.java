 ...
 */
@PerActivity
@Component(dependencies = ApplicationComponent.class, modules = {ActivityModule.class, EBookActivityModule.class})
public interface EBookActivityComponent extends ActivityComponent {
