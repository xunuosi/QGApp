...
/** 
 * DAO for table "tb_search".
*/
public class SearchDataDao extends AbstractDao<SearchData, Long> {

    public static final String TABLENAME = "tb_search";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"tb_search\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"tb_search\"";
        db.execSQL(sql);
    }
