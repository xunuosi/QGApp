...
public class CollectIndustryAnalysisPresenter extends BasePresenter<ICollectBookFragmentView, HttpManager> {
    private static final String TAG = "CollectIndustryAnalysisPresenter";
    ...
    private void transformKDBResData() {
        ...
        list = KDBResDataMapper.transformCollectDatas(collectDatas, KDBResAdapter.TYPE_INDUSTRY, false);
    ...
    public CollectIndustryAnalysisPresenter(Context context) {
