...
public class CollectStdPresenter extends BasePresenter<ICollectBookFragmentView, HttpManager> {
    private static final String TAG = "CollectStdPresenter";
    ...
    public CollectStdPresenter(Context context) {
