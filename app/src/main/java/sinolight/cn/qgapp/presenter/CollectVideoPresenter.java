...
import sinolight.cn.qgapp.views.view.ICollectVideoFragmentView;
...
public class CollectVideoPresenter extends BasePresenter<ICollectVideoFragmentView, HttpManager> {
    ...
    private void transformKDBResData() {
        ...
        list = KDBResDataMapper.transformCollectDatas(collectDatas, CommonTitleAdapter.TYPE_VIDEO, false);
    ...
    public CollectVideoPresenter(Context context) {
        this.mContext = context;
        setModel(HttpManager.getInstance());
        resType = AppContants.DataBase.Res.RES_VIDEO.getType();
    }
