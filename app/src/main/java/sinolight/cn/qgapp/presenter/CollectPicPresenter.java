...
public class CollectPicPresenter extends BasePresenter<ICollectBookFragmentView, HttpManager> {
    private static final String TAG = "CollectPicPresenter";
    ...
    private void transformKDBResData() {
        ...
        list = KDBResDataMapper.transformCollectDatas(collectDatas, KDBResAdapter.TYPE_IMG, false);
    ...
    public CollectPicPresenter(Context context) {
